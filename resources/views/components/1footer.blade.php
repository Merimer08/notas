...
<head>
    ...
    <style>
        ...
        /* --- Estilos del Footer --- */
        .site-footer {
            background-color: #1a202c; /* Gris oscuro, casi negro */
        ...
        .social-links a {
            color: #a0aec0; /* Color inicial del icono */
            transition: color 0.2s ease-in-out, transform 0.2s ease-in-out;
        }

        .social-links a:hover {
            color: #ffffff; /* El icono se vuelve blanco al pasar el cursor */
        ...
        .legal-links a {
            color: #718096; /* Un gris un poco más oscuro */
            text-decoration: none;
            transition: color 0.2s ease-in-out;
        }

        .legal-links a:hover {
            color: #a0aec0; /* Se aclara al pasar el cursor */
            text-decoration: underline;
        }
        
        .legal-links span {
            color: #4a5568; /* Color del separador */
        }
...
<body>
    ...
    <footer class="site-footer">
        <div class="footer-container">
            ...
            <div class="copyright">
                &copy; 2025 Tu Nombre o Empresa. Todos los derechos reservados.
            </div>
